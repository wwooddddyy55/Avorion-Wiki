...
W("")
W("> **In short:** profit comes from **price differences between sectors**, not from a good's base price.")
W("> Buy where a good is in **oversupply** (cheap) and sell where it's in **demand** (dear). Higher-tier")
W("> goods carry more value per unit of cargo, but the **biggest lever is cargo capacity** — a bigger hold")
W("> means more profit per run. Raw ore and scrap are not traded here; they're [refined](Refining).")
W("")
W("## Good attributes")
W("")
W("| Attribute | Meaning |")
...
W("## Trading tips")
W("")
W("- **Early game:** you don't need to memorise the table — open the **Galaxy Map's trading view** to spot")
W("  where a good is cheap vs. dear, and run that gap. Low-tier basics (ores once refined, food, fuel) move")
W("  in bulk and are a safe first income.")
W("- **Value density matters:** when your hold is small, favour **high-price, low-volume** goods so each")
W("  cubic metre of cargo earns more. As your cargo grows, bulk low-value runs scale up too.")
W("- **Watch the flags:** **Illegal** contraband sells for a lot at smuggler-friendly stations but tanks")
W("  your relations if you're caught carrying or selling it openly. **Dangerous** goods are legal.")
W("- **Mid/late game:** the real money is owning the chain — feed your own [factories](Production) their")
W("  inputs and sell their outputs. See [Production](Production) and [Player stations](Player-stations).")
W("")
W("## See also")
W("")
